...
n=1,2,4,8,16,32
OUTPUTS:
Execution time with 1 processes: 0.020845 seconds
Execution time with 2 processes: 0.017403 seconds
Execution time with 4 processes: 0.015677 seconds
Execution time with 8 processes: 0.015102 seconds
Execution time with 16 processes: 0.125972 seconds
Execution time with 32 processes: 0.307313 seconds
*/

/*
things to note:
- The execution time decreases as the number of processes increases up to 8 processes.
- MPI cannot handle 3d arrays directly, so we need to flatten the arrays and scatter them.
- for a simple calculation like this, sending back and forth takes more time is more time intensive
*/
